...
<head>
    <meta charset="utf-8">
    <title>添加/修改菜品</title>
    <link rel="stylesheet" href="${APP_CONTEXT}/common/layui/css/layui.css" media="all">
    <script src="${APP_CONTEXT}/js/jquery-1.8.3.js"></script>
    <script type="text/javascript" src="${APP_CONTEXT}/common/layui/layui.js"></script>
    <style type="text/css">
        .file {
            position: relative;
            width: 100px;
    ...
    <script type="text/javascript" src="${APP_CONTEXT}/common/js/Addcaipu.js"></script>
</head>
<body>
<header style="width: 100%;height: 40px;background-color: #E3E3E3;">
    <h2 style="text-align: left;padding-left: 15px;padding-top: 5px;font: 18px/30px 宋体;"><b>添加菜品</b></h2>
</header>
    ...
    <form id="frm" class="layui-form" enctype="multipart/form-data" method="post" action="addMenu">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" value="${updateMenuInfo.MName}" name="mname" id="mname" placeholder="请输入"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" value="${updateMenuInfo.MPrice}" name="mprice" id="mprice" placeholder="请输入价格"
                       autocomplete="off" class="layui-input">
            </div>
                ...
                <select name="typeid" id="typeid" lay-verify="required">
                    ...
                    <%--	<c:if test="${empty updateMenuInfo}">
                         ...
                         <c:forEach items="${mlist}" var="mlist">
                            <option value="${mlist.id}">${mlist.typeName}</option>
                        </c:forEach>
                 </select>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline file">
                <img id="images" src="${APP_CONTEXT}/common/icon/image.png"/>
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-inline">
                <textarea name="remark" id="remark" placeholder="请输入内容"
                          class="layui-textarea">${updateMenuInfo.remark}</textarea>
            </div>
        </div>
        <div class="layui-form-item">
