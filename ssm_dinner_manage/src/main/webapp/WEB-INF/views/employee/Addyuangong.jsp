...
<head>
    ...
    <script src="${APP_CONTEXT}/common/js/Addyuangong.js"></script>
</head>
<body>
...
<section style="border: 0px solid red;width: 500px;margin: 20px auto;">
    <form class="layui-form" action="" method="post" id="frm">
        <input type="text" name="id" id="id" value="${Upuser.id}" readonly="readonly" hidden="hidden">
        <div class="layui-form-item">
            <label class="layui-form-label">登录名：</label>
            <div class="layui-input-inline">
                <input type="text" value="${Upuser.ULoginname}" name="ULoginname" id="loginname" placeholder="请输入"
        ...
        <div class="layui-form-item" <c:if test="${Upuser.URole==1}">
            ...
            <div class="layui-input-inline">
                <input type="password" value="${Upuser.UPwd}" name="UPwd" id="pwd" placeholder="请输入密码" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item" <c:if test="${Upuser.URole==1}">
            ...
            <div class="layui-input-inline">
                <select name="URole" id="role" lay-verify="required">
                   ...
                   <!--  <option value="2" <c:if test="${Upuser.URole==2}">selected="selected"</c:if>>总经理</option>
                    ...
                    <option value="3" <c:if test="${Upuser.URole==3}">selected="selected"</c:if>>员工</option>
                </select>
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-inline">
                <input type="text" value="${Upuser.UName}" name="UName" id="uname" placeholder="请输入姓名"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="USex" value="男" title="男"
                       <c:if test="${Upuser.USex=='男'}">checked="checked"</c:if>>
                <input type="radio" name="USex" value="女" title="女"
                       <c:if test="${Upuser.USex=='女'}">checked="checked"</c:if>>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">手机：</label>
            <div class="layui-input-inline">
                <input type="tel" value="${Upuser.UPhone}" name="UPhone" id="phone" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" value="${Upuser.UIdcard}" name="UIdcard" id="idcard" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" value="${Upuser.UAddress}" name="UAddress" id="address" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
