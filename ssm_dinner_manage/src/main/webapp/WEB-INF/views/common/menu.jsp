...
<div class="nano-content">
    <ul>
        ...
        <li><a class="sidebar-sub-toggle"><i class="ti-heart"></i> 菜品管理 <span
                class="sidebar-collapse-icon ti-angle-down"></span></a>
            <ul>
                <li><a href="${APP_CONTEXT}/caipu" target="iframe_a">查看菜品</a></li>
                <li><a href="${APP_CONTEXT}/addcaipu" target="iframe_a">添加菜品</a></li>
                <li><a href="${APP_CONTEXT}/caiputype" target="iframe_a">菜品类型</a></li>
            </ul>
        </li>
