...
public interface UsersDao {
    ...
    //修改
    @Update("UPDATE ssm_dinner_manage.users SET u_loginname =#{uLoginname} , " +
    ...
    @Insert("INSERT INTO ssm_dinner_manage.users ( u_loginname, u_pwd, u_name, u_sex, u_phone, u_idcard, u_address, u_role) VALUES (#{uLoginname} ," +
