...
//        return "dayinfo";
    ...
    public String addCaipu(ModelMap modelMap) {
         ...
         modelMap.addAttribute("mlist", allMenuType);
    ...
    public String canzuosyqk(ModelMap modelMap) {
        List<DiningTable> diningTables1 = this.diningTableservice.getdiningTable();
        modelMap.addAttribute("dtableList1", diningTables1);
        List<DiningTable> diningTables2 = this.diningTableservice.getdiningUseTable();
        modelMap.addAttribute("dtableList2", diningTables2);
