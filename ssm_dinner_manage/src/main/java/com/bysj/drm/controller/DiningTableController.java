...
public class DiningTableController {
    ...
    public CommonResults deltable(@RequestParam("delid") Integer delid) {
        DiningTable oneuser = diningTableservice.getOneTable(delid);
         
        int delTbale = diningTableservice.delDiningTable(delid);
        return delTbale == 1 ? CommonResults.success() : CommonResults.failure();
